$locales = @(
  ...
  @{ number = 'Local 6'; name = 'OPI Joseph Olivera'; category = 'Belleza'; image = 'uploads/Josep-Olivera.webp'; phone = '2615520664'; instagram = 'https://www.instagram.com/josepholivera.ar/'; galleryFolder = 'joseph olivera' },
  @{ number = 'Local 7 y 8'; name = 'Peluqueria Joseph Olivera'; category = 'Belleza'; image = 'uploads/Josep-Olivera.webp'; description = "Joseph Olivera ofrece un espacio integral para tu bienestar, belleza y salud. En salones modernos y comodos, un equipo profesional utiliza tecnicas de vanguardia y productos de alta calidad para realzar tu hermosura natural, con atencion personalizada."; hours = 'Martes a Sabados: 9:30 a 20:30'; phone = '2615520664'; instagram = 'https://www.instagram.com/josepholivera.ar/'; galleryFolder = 'joseph olivera' },
  @{ number = 'Local 9'; name = 'Optica Godoy Cruz'; category = 'Salud'; image = 'uploads/Optica-Godoy-Cruz.webp'; description = "Empresa orientada a la salud visual, dedicada a la venta de anteojos y lentes de contacto, con surtido moderno y novedades de las ultimas colecciones."; hours = 'Lunes a Sabados: 9:30 a 13:30 y 17:30 a 21'; phone = '+5492612750735'; instagram = 'https://www.instagram.com/opticagodoycruz/'; galleryFolder = 'optica  gc' },
  @{ number = 'Local 9 A'; name = 'Al Mundo'; category = 'Servicios'; image = 'uploads/Almundo.webp'; description = "Almundo te acerca las mejores propuestas para planificar tus viajes de forma segura y completa: aqui podras reservar tus alojamientos, vuelos y traslados, ademas de contratar tu asistencia al viajero y alquilar autos en destino.`n`nNuestros expertos en viajes son profesionales del turismo y acompanan a nuestros pasajeros antes, durante y despues de sus vacaciones."; phone = '5492617243748'; email = 'dalvian@almundofr.com'; hours = '9 a 22hs'; instagram = 'https://www.instagram.com/almundo_ar/'; galleryFolder = 'almundo' },
  @{ number = 'Local 10'; name = 'Guarnieri'; category = 'Indumentaria'; image = 'uploads/Guarnieri.webp'; description = "Guarnieri es la marca de medias, lenceria y ropa interior lider en Mendoza desde 1920. Ahora mas cerca tuyo."; hours = 'Lunes a Sabados: 9:30 a 13:30 y 17:30 a 21:30'; instagram = 'https://www.instagram.com/guarnieri1920/'; disableGallery = $true },
  @{ number = 'Local 10 A'; name = 'MDZ Shop Tecnolab'; category = 'Varios'; image = 'uploads/MDZ-Shop.webp'; description = "Con mas de 8 anos de experiencia, MDZShop es una empresa lider y referente en Mendoza. Venta de smartphones y accesorios, informatica, toners y cartuchos, camaras fotograficas, notebooks y car audio. Servicio tecnico especializado en smartphones, tablets, informatica y electronica en general."; phone = '4441493'; hours = 'Lunes a Viernes: 9:30 a 13:30 y de 17 a 21 Sabados: 10 a 13 y 17 a 20'; galleryFolder = 'mdz shop' },
  @{ number = 'Local 11'; name = 'Queen Energia'; category = 'Servicios'; image = 'uploads/queen-energia-white.png'; description = "Nuestros productos estan rigurosamente seleccionados con la ayuda de nutricionistas y bromatologos. Con el fin de brindarte todos los nutrientes que tu cuerpo necesita, nos orientamos a un Realfooding, ofreciendo las mejores ofertas del mercado cuidando siempre la calidad nutricional y sin limitar el placer de comer."; instagram = 'https://www.instagram.com/queen.energia/'; phone = '+54 9 2617 23-2007'; hours = 'Lun a Sab de 9 am a 8:30 pm'; keepColor = $true; galleryFolder = 'queen energia' },
  @{ number = 'Local 12'; name = 'La Matilde Focacheria'; category = 'Gastronomia'; image = 'uploads/la-matilde-focacheria 2.png'; description = "Focacceria artesanal con focaccias recien horneadas, combinaciones clasicas y de autor, ingredientes frescos y sabores mediterraneos. Ideal para compartir o comer al paso, con opciones saladas y dulces."; instagram = 'https://www.instagram.com/lamatilde.focacceria/'; phone = '261 243-9760'; hours = 'Lun a Dom de 11 am a 11 pm'; keepColor = $true; galleryFolder = 'la matilde focacceria' },
  @{ number = 'Local 12 A'; name = 'Panco Sushi'; category = 'Gastronomia'; image = 'uploads/Panko-1.webp'; instagram = 'https://www.instagram.com/pankosushiok/'; keepColor = $true; galleryFolder = 'panko sushi' },
  @{ number = 'Local 13'; name = 'Jack House'; category = 'Gastronomia'; image = 'uploads/Jack-House.webp'; description = "Hamburguesas con actitud, ingredientes frescos, panes artesanales y combinaciones intensas. Desde la clasica hasta la mas jugada, cada burger esta pensada para los amantes de las hamburguesas de verdad."; phone = '+54 9 2616 17-7278'; instagram = 'https://www.instagram.com/jack__house/'; hours = 'Todos los dias de 20 a 23:50'; galleryFolder = 'jackhouse' },
  @{ number = 'Local 14'; name = 'Wine Stop'; category = 'Gastronomia'; image = 'uploads/Fullescabio.png'; description = "Wine Stop ofrece una seleccion de bebidas alcoholicas para cada ocasion: vinos, cervezas, destilados y licores. Variedad, calidad y atencion personalizada para que siempre encuentres la opcion ideal."; hours = 'Lunes a Viernes: 09:30 a 13:30 y 17:30 a 21:30'; galleryFolder = 'winestop(fullescabio)' },
  ...
  @{ number = 'Local 18'; name = 'Entre Dos Cafe y Helados'; category = 'Gastronomia'; image = 'uploads/entre-dos3.png'; description = "Somos una empresa mendocina dedicada a la elaboracion de productos y alfajores premium. Nuestro proceso de produccion es una perfecta amalgama de lo tradicional con lo actual, conservando la calidad y la calidez de los procesos manuales junto con tecnicas avanzadas de fabricacion."; instagram = 'https://www.instagram.com/entredosalfajores/?hl=es'; galleryFolder = 'entre dos' },
  @{ number = 'Local 19'; name = 'Prestigio Pintureria'; category = 'Hogar'; image = 'uploads/Prestigio.webp'; description = "En Pintureria Prestigio te acompanamos en cada proyecto con asesoramiento experto y una amplia gama de pinturas, revestimientos y accesorios de calidad. Trabajamos con marcas lideres para garantizar acabados duraderos y resultados que superan tus expectativas. Dale color a tus ideas con Prestigio."; hours = 'Lunes a Viernes: 08:30 a 12:30 y 16:00 a 20:30 Sabados: 08:30 a 12:30 y 16:30 a 20:30'; phone = '261 15-568-1215'; instagram = 'https://www.instagram.com/prestigio.ok/'; galleryFolder = 'prestigio' },
  ...
  @{ number = 'Local 21'; name = 'Punto Fix'; category = 'Hogar'; image = 'uploads/punto fix.png'; description = "Trabajamos para simplificar el dia a dia de las personas, respondiendo con eficiencia, profesionalismo y calidez a las necesidades que surgen en el ambito del hogar."; phone = '2617188050'; hours = 'Lunes a Viernes: 9 a.m. a 6 p.m. Sabado: 9 a.m. a 1 p.m. Domingo: Cerrado'; galleryFolder = 'punto fix'; keepColor = $true },
  @{ number = 'Local 22 y 23'; name = 'Carnes Rizzo'; category = 'Gastronomia'; image = 'uploads/Carnes-Rizzo-logo.png'; description = "Carnes Rizzo es una empresa familiar en la que los herederos continuan la tradicion que su padre, Jose Rizzo, ganadero y carnicero a la vez, inicio hace mas de 50 anos. Bajo el concepto El nombre de la carne en Mendoza, acercan cortes tradicionales y la esencia mas pura de las carnes autenticas."; instagram = 'https://www.instagram.com/carnesrizzo.mza/?hl=es-la'; galleryFolder = 'carnes rizzo' },
  @{ number = 'Local 24'; name = 'Chacras Pets'; category = 'Varios'; image = 'uploads/chacras_pet_s-removebg-preview.png'; description = "La salud y bienestar de tu mascota es lo mas importante. Brindamos un excelente servicio para que tu mejor amigo este bien. Servicio veterinario a domicilio, amplia variedad de alimentos y las mejores marcas. Hacemos envios a domicilio."; hours = 'Lunes a Sabados: 10 a 13:30 y 17:30 a 21:30'; instagram = 'https://www.instagram.com/chacras_pets/?hl=es-la'; galleryFolder = 'chacras pet' },
...
"@
  ...
  if (-not $galleryFolder -and -not $loc.disableGallery) {
  ...
  if ($galleryFolder) {
    $galleryImages = Get-ChildItem -Path $galleryFolder -File | Where-Object { $_.Extension -match '\.(jpg|jpeg|png|webp|jfif)$' } | Sort-Object Name
